...
import ProductInfoLOJA8 from "@/components/ProductInfoLOJA8";
      ...
      <div className="w-full max-w-none md:max-w-sm md:mx-auto bg-background">
        ...
        <main className="px-4 py-4">
          ...
          <div className="space-y-6">
            ...
            <ProductInfoLOJA8 onVariantChange={setSelectedImageIndex} />
          </div>
        </main>
...
export default ProductPageLOJA8;
