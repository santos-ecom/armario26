...
interface ProductInfoLOJA7Props {
  onVariantChange?: (imageIndex: number) => void;
}

const ProductInfoLOJA7 = ({ onVariantChange }: ProductInfoLOJA7Props) => {
  ...
  const quantityOptions = [
    {
      ...
      discount: "90%",
      label: "1 Unit",
      url: "https://wybyxn-mv.myshopify.com/cart/42624265257044:1"
    },
    {
      id: "2", 
      quantity: 2,
      ...
      savings: "Save $13.00",
      popular: true,
      url: "https://wybyxn-mv.myshopify.com/cart/42624265289812:1"
    },
    {
      id: "3",
      quantity: 3,
      ...
      label: "3 Units",
      savings: "Save $29.00",
      url: "https://wybyxn-mv.myshopify.com/cart/42624265322580:1"
    }
  ];

  const additionalUrls = {
    "4": "https://wybyxn-mv.myshopify.com/cart/42624265355348:1",
    "5": "https://wybyxn-mv.myshopify.com/cart/42624265388116:1"
  };
...
export default ProductInfoLOJA7;
