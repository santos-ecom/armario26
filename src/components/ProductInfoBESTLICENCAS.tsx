...
interface ProductInfoBESTLICENCASProps {
  onVariantChange?: (imageIndex: number) => void;
}

const ProductInfoBESTLICENCAS = ({ onVariantChange }: ProductInfoBESTLICENCASProps) => {
...
export default ProductInfoBESTLICENCAS;
