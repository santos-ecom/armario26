...
interface ProductInfoEASYProps {
  onVariantChange?: (imageIndex: number) => void;
}

const ProductInfoEASY = ({ onVariantChange }: ProductInfoEASYProps) => {
  ...
  const quantityOptions = [
    {
      ...
      discount: "90%",
      label: "1 Unit",
      url: "https://tga1pa-kh.myshopify.com/cart/47031362486528:1"
    },
    {
      id: "2", 
      quantity: 2,
      ...
      savings: "Save $13.00",
      popular: true,
      url: "https://tga1pa-kh.myshopify.com/cart/47031362519296:1"
    },
    {
      id: "3",
      quantity: 3,
      ...
      label: "3 Units",
      savings: "Save $29.00",
      url: "https://tga1pa-kh.myshopify.com/cart/47031362552064:1"
    }
  ];

  // URLs for quantities 4 and 5 (used by the +/- selector)
  const additionalUrls = {
    "4": "https://tga1pa-kh.myshopify.com/cart/47031362584832:1",
    "5": "https://tga1pa-kh.myshopify.com/cart/47031362617600:1"
  };
...
export default ProductInfoEASY;
