...
interface ProductInfoPRIMEProps {
  onVariantChange?: (imageIndex: number) => void;
}

const ProductInfoPRIME = ({ onVariantChange }: ProductInfoPRIMEProps) => {
  ...
  const quantityOptions = [
    {
      ...
      discount: "90%",
      label: "1 Unit",
      url: "https://1izi5u-xh.myshopify.com/cart/45492789936313:1"
    },
    {
      id: "2", 
      quantity: 2,
      ...
      savings: "Save $13.00",
      popular: true,
      url: "https://1izi5u-xh.myshopify.com/cart/45492789969081:1"
    },
    {
      id: "3",
      quantity: 3,
      ...
      label: "3 Units",
      savings: "Save $29.00",
      url: "https://1izi5u-xh.myshopify.com/cart/45492790001849:1"
    }
  ];

  // URLs for quantities 4 and 5 (used by the +/- selector)
  const additionalUrls = {
    "4": "https://1izi5u-xh.myshopify.com/cart/45492790034617:1",
    "5": "https://1izi5u-xh.myshopify.com/cart/45492790067385:1"
  };
...
export default ProductInfoPRIME;
