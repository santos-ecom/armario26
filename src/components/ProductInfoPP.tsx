...
interface ProductInfoPPProps {
  onVariantChange?: (imageIndex: number) => void;
}

const ProductInfoPP = ({ onVariantChange }: ProductInfoPPProps) => {
  ...
  const quantityOptions = [
    {
      ...
      discount: "90%",
      label: "1 Unit",
      url: "https://1anxix-g1.myshopify.com/cart/46937902252250:1"
    },
    {
      id: "2", 
      quantity: 2,
      ...
      savings: "Save $13.00",
      popular: true,
      url: "https://1anxix-g1.myshopify.com/cart/46937902285018:1"
    },
    {
      id: "3",
      quantity: 3,
      ...
      label: "3 Units",
      savings: "Save $29.00",
      url: "https://1anxix-g1.myshopify.com/cart/46937902317786:1"
    }
  ];

  // URLs for quantities 4 and 5 (used by the +/- selector)
  const additionalUrls = {
    "4": "https://1anxix-g1.myshopify.com/cart/46937902350554:1",
    "5": "https://1anxix-g1.myshopify.com/cart/46937902383322:1"
  };
