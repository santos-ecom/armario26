...
const Footer = () => {
  return (
    <footer className="bg-primary text-primary-foreground pb-24">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 gap-8">
          ...
          <div className="text-center">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3 justify-center">
                ...
                <span className="text-sm">Atendimento: seg. à sex.</span>
              </div>
              <div className="flex items-center gap-3 justify-center">
          ...
          {/* FORMAS DE PAGAMENTO E LOJA VERIFICADA */}
          <div>
            <div className="mb-8">
            ...
            <div>
              <div className="flex items-center justify-center">
                <img 
                  ...
                  alt="Google Safe Browsing - Loja Verificada" 
