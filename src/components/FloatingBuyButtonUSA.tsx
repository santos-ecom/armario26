  ...
  return (
    <div className={`fixed bottom-4 left-4 right-4 z-40 max-w-sm mx-auto animate-slide-in-right ${isVisible ? 'animate-fade-in' : 'animate-fade-out'}`}>
      <div className="p-4">
        {/* Buy button */}
        <Button 
          className="w-full bg-primary hover:bg-primary/90 text-primary-foreground font-semibold py-3 border border-black"
          size="lg"
...
export default FloatingBuyButtonUSA;
