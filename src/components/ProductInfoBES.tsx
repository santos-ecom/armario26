...
interface ProductInfoBESProps {
  onVariantChange?: (imageIndex: number) => void;
}

const ProductInfoBES = ({ onVariantChange }: ProductInfoBESProps) => {
  ...
  const quantityOptions = [
    {
      ...
      discount: "93%",
      label: "1 Unit",
      url: "https://5qxzc2-13.myshopify.com/cart/44292306010251:1"
    },
    {
      id: "2", 
      quantity: 2,
      ...
      savings: "Save $3.00",
      popular: true,
      url: "https://5qxzc2-13.myshopify.com/cart/44292306043019:1"
    },
    {
      id: "3",
      quantity: 3,
      ...
      label: "3 Units",
      savings: "Save $9.00",
      url: "https://5qxzc2-13.myshopify.com/cart/44292306075787:1"
    }
  ];

  // URLs for quantities 4 and 5 (used by the +/- selector)
  const additionalUrls = {
    "4": "https://5qxzc2-13.myshopify.com/cart/44292306108555:1",
    "5": "https://5qxzc2-13.myshopify.com/cart/44292306141323:1"
  };
  ...
  const getSelectedUrl = () => {
    ...
    // For quantities 4 and 5, use the additional URLs
  ...
  const getSelectedPrice = () => {
    ...
    // For quantities 4 and 5, calculate price based on pattern
    const qty = parseInt(selectedQuantity);
    if (qty === 4) return 76.00;
    if (qty === 5) return 95.00;
